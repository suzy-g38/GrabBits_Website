    ...
    return (
        <>
            <section className="Faqs section" id="Faqs">
                ...
                <span className="section__subtitle">have questions we are here to help you</span>
                <div style={
                    {
                        display: 'flex',
                    ...
                    <div className="Contact__container container grid">
                        <form onSubmit={submitHandler}>
                            ...
                            <h3 className="contact__title">
                                <MdOutlineContactSupport size={'2rem'} /> Contact Us</h3>
                            <Input
                                className="inputText"
                        ...
                        <div>
                            {Faqs.map((item) => (
                                <div
                                    ...
                                    className={selectedId === item.id ? "Faqs__content Faqs__open" : "Faqs__content Faqs__close"}
                                >
                                    <div className="Faqs__header">
                                        ...
                                        <i className="uil uil-angle-down Faqs__arrow" onClick={() => handleClick(item.id)}></i>
