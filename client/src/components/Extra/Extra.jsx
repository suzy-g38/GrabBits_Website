        ...
        <div className={classes.extra_bg}>
            <div className={classes.wrapper}>
                <div className={classes.box1}>
                    ...
                    <p className={classes.para}>Lorem ipsum dolor sit amet consectetur.</p>
                </div>
            ...
            <div className={classes.content}>
                <div className={classes.head1}>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maxime numquam eos quisquam ut optio iure ad omnis voluptates eaque culpa?</div>
